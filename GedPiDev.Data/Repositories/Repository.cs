using GedPiDev.Domain.Interfaces;
using System;
...
namespace GedPiDev.Data.Repositories
{
    public class Repository<T> : IRepository<T> where T : class
    {
        private readonly GedPiDevContext _context;
        private IDbSet<T> _dbSet;

        public Repository(GedPiDevContext context)
        {
            _context = context;
