...
namespace GedPiDev.WebPresentationLayer.Controllers
{
    [Authorize]
    public class AccountMVCController : Controller
    {
        ...
        public AccountMVCController(UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    return RedirectToAction("Index", "AccountMVC");
                }
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult> Manage(AccountMVCViewModel model)
        {
